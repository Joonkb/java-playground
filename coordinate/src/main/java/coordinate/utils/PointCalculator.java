...
public class PointCalculator {
    ...
    public static double calculateArea(Rectangle rectangle) {
        ...
        List<Point> pointList = rectangle.getPoints();
    ...
    public static double calculateArea(Triangle triangle) {
        ...
        List<Point> pointList = triangle.getPoints();
        Point p0 = pointList.get(0);
        Point p1 = pointList.get(1);
        Point p2 = pointList.get(2);

        Figure l0 = new Line(Arrays.asList(p0, p1));
        Figure l1 = new Line(Arrays.asList(p1, p2));
        Figure l2 = new Line(Arrays.asList(p2, p0));
